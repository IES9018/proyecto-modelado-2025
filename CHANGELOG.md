...
### Added (Agregado)
- **Sistema de Categorías Mejorado:** Se incluye el modelado (Diagrama de Clases, Secuencia y Actividad) para la entidad `Categoria`, que permite categorizar artículos de forma flexible. (Esta es la funcionalidad única de EzeBlog).
